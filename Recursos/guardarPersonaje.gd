...
func guardarPersonaje():
	...
	if !Personaje.nombre.is_empty():
		...
		archivoConfig.set_value(nombre,"Primera Mano Estadistica",Personaje.primeraManoEstadistica)
		...
		archivoConfig.set_value(nombre,"Segunda Mano Estadistica",Personaje.segundaManoEstadistica)
...
func cargarPersonaje(rutaArchivo : String):
	...
	Personaje.primeraManoEstadistica = archivoConfig.get_value(nombre,"Primera Mano Estadistica","")
	...
	Personaje.segundaManoEstadistica = archivoConfig.get_value(nombre,"Segunda Mano Estadistica","")
